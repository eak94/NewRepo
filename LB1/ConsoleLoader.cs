                    ...
                    case 3:
                        ...
                        while (true)
                        {
                            ...
                            switch (what)
                            {
                                case 1:
                                    {
                                        Console.WriteLine("Метаболический эквивалент (MET) для бега: \n" +
                                ...
                                case 2:
                                    {
                                        Console.WriteLine("Метаболический эквивалент (MET) для плавания: \n" +
                                            "Брасс: 5 MET\n" +
                                ...
                                case 3:
                                    {
                                        Console.WriteLine("Метаболический эквивалент (MET) для жима штанги" +
                                ...
                                default:
                                    {
                                        Console.WriteLine("Выбранного упражнения нет в списке. Попробуйте еще раз.");
                                        break;
                                    }
                            }
                            break;
